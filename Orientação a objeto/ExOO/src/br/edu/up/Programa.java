...
public class Programa {
	...
	public static void main(String[] args) {
		...
		Cachorro cachorro1 = new Cachorro(); //cachorro1 é o objeto
		...
		//Não é possível adicionar na lista de cachorro quando for diferente de cachorro
		listaDeAnimais.add(umObjetoQualquer); //Pode adicionar na lista de animal porque é Herança do Objeto PAI
